...
public class Train {
    ...
    public Train (String trainId,String departure,String arrival,LocalDateTime departureTime,LocalDateTime arrivalTime,TrainType type,int seats){
        ...
        this.availableSeats=this.RESERVABLE ? availableSeats:-1; //Se il treno è prenotabile come posti disponibili avremo quelli passati nel costruttore altrimenti è un informazione inutile e passiamo -1
    ...
    public String toString(){
        return TRAIN_ID+" [ "+type+" ] "+" | "+DEPARTURE+" | "+ARRIVAL+" | "+DEPARTURE_TIME+" | Posti Disponibili: "+availableSeats+" | Stato Treno: "+status;
    }
